...
import { genshinTheme } from './themes/genshin';
...
// 主题
const themes = [genshinTheme, defaultTheme, fishermanTheme, jinlunTheme, ikunTheme];
...
const App: FC = () => {
    const [curTheme, setCurTheme] = useState<Theme<any>>(genshinTheme);
